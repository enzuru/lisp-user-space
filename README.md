...
You can have your [user space tools written in Emacs Lisp](https://github.com/enzuru/.emacs.d), your [window management handled by Common Lisp](https://github.com/enzuru/.stumpwm.d), and [your system configuration declaratively written in Guile Scheme](https://github.com/enzuru/profiles).
